      ...
      child: ClipRRect(
        ...
        child: DecoratedBox(
          ...
          child: CustomPaint(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                color: Colors.white.withOpacity(0.45), // stronger translucent wash
              ),
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FilledButton(
                      style: FilledButton.styleFrom(
                        backgroundColor: Colors.white,
                        foregroundColor: const Color(0xFF4E3BD4),
                        shape: RoundedRectangleBorder(
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        const SizedBox(height: 10),
        const ShimmerBlock(
            height: 190, radius: 26, margin: EdgeInsets.fromLTRB(6, 10, 6, 0)),
        const SizedBox(height: 14),
        const ShimmerBlock(
            height: 230,
            radius: 28,
        ...
        const Padding(
            ...
            child:
                ShimmerBlock(height: 22, radius: 6, margin: EdgeInsets.zero)),
        const SizedBox(height: 12),
        ...List.generate(
          3,
          (_) => const Padding(
